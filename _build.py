...
# -*- coding: utf-8 -*-
"""組裝《代碼壁壘》成品:
  1) 合併單一 Markdown 檔  代碼壁壘_全書.md
  2) 圖文 HTML(側邊子目錄)  代碼壁壘.html
版面沿用《代理覺醒》_build.py(同一套 CSS / 解析器),
內容為技術評註書(蒸餾、代理操作與快取的工程實錄)。
...
BOOK_TITLE = "代碼壁壘"
BOOK_SUB   = "蒸餾、代理操作與快取的工程實錄 · The Code Barrier"
COVER_CANDIDATES = ["TheCodeBarrier.png", "CodeBarrier.png", "代碼壁壘.png", "cover.png"]
...
def build_merged():
    ...
    parts.append("> 全書合併版。本書為教育與研究用途，橫跨蒸餾、代理操作與快取三大主題"
                 "的整理與批判性評註。\n")
    parts.append("\n---\n\n## 目錄\n")
    for base in FILES:
