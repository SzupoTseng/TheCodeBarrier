#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble the English edition of "The Code Barrier":
...
BOOK_TITLE = "The Code Barrier"
BOOK_SUB   = "The Engineering of Distillation, Agents, and Cache"
...
def part_for(text):
    m = re.search(r'^#\s+(Part\s+[IVXLC]+\b.*)$', text, re.M)
...
def build_merged():
    ...
    parts.append("> Merged edition. This book is for educational and research purposes — an organization and "
                 "critical annotation spanning three themes: distillation, agentic computer use, and caching.\n")
    parts.append("\n---\n\n## Table of Contents\n")
    for base in FILES:
